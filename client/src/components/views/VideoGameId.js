    ...
    return (
        <div className="containerVideoGameId">
            ...
            <div className="cardVideogameId">
                ...
                <div className="releaseDateVideoGameId">{game_id.releaseDate}</div>
                <div className="ratingDateVideoGameId">{game_id.rating}</div>

                <div className="descriptionVideoGameId">
                   <p> { (game_id.description) && parse(game_id.description)}</p>
                </div>
                <div className="GenderPlatforVideoGameId">
